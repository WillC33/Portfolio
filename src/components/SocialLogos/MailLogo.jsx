...
export const MailLogo = ({colour, size}) => {
    return (
        <a href="mailto:william@williamcooke.net">
            <svg className={styles.fadingButton} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={size} height={size} viewBox="0 0 48 48">
                <path fill={colour}
                      d="M34,42H14c-4.411,0-8-3.589-8-8V14c0-4.411,3.589-8,8-8h20c4.411,0,8,3.589,8,8v20 C42,38.411,38.411,42,34,42z"></path>
                <path fill="#fff"
